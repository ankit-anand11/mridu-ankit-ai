...
| Parameter | Decision |
|---|---|
| **Session format** | Individual semi-structured interviews |
| **Designer sessions** | 3-4 participants, 30 min each |
| **Developer sessions** | 3-4 participants, 30 min each |
...
> **Note on session format:** Run all sessions as individual 1:1 interviews —
> not group sessions. Group dynamics suppress candid feedback about gaps and
> shortcuts. You need individual workflow stories, not consensus. The variance
> between a Carbon-disciplined designer and one who cuts corners under deadline
> is the signal; a group session will flatten it.

---

## Guide 1 — Designer Interview
...
1. Tell me about your role and the product you're currently designing for.

---

### Section A — Carbon adoption in practice (10 min)

2. Walk me through how you start a new screen or flow. Where does Carbon fit in
   that process — do you reach for it from the start, or does it come in later?
3. Are there parts of Carbon — specific components, spacing, tokens, typography
   — that you find harder to apply consistently? What makes them harder?
4. Tell me about a time the right Carbon component didn't exist or didn't fit.
   What did you do?

---

### Section B — Review, gaps, and release pressure (13 min)

5. Describe how design reviews work on your team — who's involved, how often,
   and at what stage of the release cycle.
6. What kinds of things get flagged most often? Walk me through a recent
   example, and how you addressed it.
7. Tell me about a feature that shipped with known Carbon gaps — or without a
   complete review. What were the circumstances?
8. When time is short, how do you decide what to fix versus defer? Who else is
...
9. If you had a tool that gave you instant Carbon feedback on your Figma work
   before any human reviewer sees it — how would you use it, and what would
   make you trust it?
10. Anything important about your review experience I haven't asked about?
